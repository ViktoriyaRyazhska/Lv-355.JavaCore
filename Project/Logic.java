...
public class Logic {
	...
	static void winner(JButton[] jButtons) {
		if ((jButtons[0].getText().equals(jButtons[1].getText()))
			...
			tryAgain();
		} else if ((jButtons[3].getText().equals(jButtons[4].getText()))
			...
			answer = JOptionPane.showConfirmDialog(JavaFrame.jPanel,
					...
					JOptionPane.YES_NO_OPTION);
			tryAgain();
		} else if ((jButtons[6].getText().equals(jButtons[7].getText()))
			...
			answer = JOptionPane.showConfirmDialog(JavaFrame.jPanel,
					...
					JOptionPane.YES_NO_OPTION);
			tryAgain();
		} else if ((jButtons[0].getText().equals(jButtons[3].getText()))
				&& (jButtons[0].getText().equals(jButtons[6].getText())) && (!jButtons[0].getText().isEmpty())) {
			answer = JOptionPane.showConfirmDialog(JavaFrame.jPanel,
					"Player " + jButtons[0].getText() + " is winner! Do u want to exit?", "Congradulation!",
					JOptionPane.YES_NO_OPTION);
			tryAgain();
		} else if ((jButtons[1].getText().equals(jButtons[4].getText()))
			...
			answer = JOptionPane.showConfirmDialog(JavaFrame.jPanel,
					...
					JOptionPane.YES_NO_OPTION);
			tryAgain();
		} else if ((jButtons[2].getText().equals(jButtons[5].getText()))
